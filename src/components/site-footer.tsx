...
export function SiteFooter() {
  return (
    <footer className="mx-auto flex w-full max-w-screen-xl flex-col gap-2 px-3 py-6 text-sm text-fg/75">
      <div className="flex flex-wrap items-center gap-2">
        <Searchbar
          id="site-footer"
          className="motion-safe:transform-colors group flex grow items-center gap-1 rounded-md border border-border bg-muted py-1 pl-2 focus-within:bg-input"
        >
      ...
      <div className="flex flex-col gap-1 border-t border-t-border py-2 lg:py-6">
        <p>
        ...
        <p>
          Card prices represent estimates and/or market values. No guarantee of
